    ...
    testimonials: [
      {
        ...
        content:
          "Fantastyczny kurs! Dzięki niemu zrozumiałam React i mogłam zmienić pracę na lepszą.",
        rating: 5,
      },
      {
        name: "Michał Nowak",
        ...
        content:
          "Bardzo praktyczny kurs z wieloma przykładami. Polecam każdemu kto chce nauczyć się React.",
        rating: 5,
      },
      {
        ...
        content:
          "Świetne wytłumaczenie trudnych konceptów. Instruktor ma dar przekazywania wiedzy.",
        rating: 5,
      },
    ],
  },
              ...
              <GlassCard className="p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {course.testimonials?.map((testimonial, index) => (
                    <div
                      key={index}
                      className="bg-white/10 dark:bg-slate-800/10 rounded-xl p-6"
                    >
